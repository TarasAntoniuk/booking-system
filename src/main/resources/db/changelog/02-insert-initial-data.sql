...
VALUES ('admin', 'admin@booking.com'),
       ('john_doe', 'john@example.com'),
       ('jane_smith', 'jane@example.com');

--changeset taras:8-insert-test-units
INSERT INTO units (number_of_rooms, accommodation_type, floor, base_cost, description, owner_id)
VALUES (2, 'FLAT', 3, 100.00, 'Cozy 2-room flat on 3rd floor', 1),
       (3, 'APARTMENT', 5, 150.00, 'Spacious 3-room apartment with balcony', 1),
       (1, 'HOME', 1, 80.00, 'Small house with garden', 2),
       (4, 'APARTMENT', 2, 200.00, 'Luxury 4-room apartment', 2),
       ...
       (2, 'APARTMENT', 6, 120.00, 'Modern apartment with great view', 2),
